...
const {valueShow , click, setNumber, setPath, setNav, setBackDrop, setContact} = useContext(Context)
    ...
    <div className= {classes.NavigationBar} style = {{height: valueShow ? "100% ": "0"}} >
        {valueShow ?
         <ul className={classItm}>
            ...
            <motion.li initial="rest" whileHover="hover" animate="rest"  name = {"contact"}><a href onClick = {() => {setContact(true); click()}} name = "contact" ><motion.span variants = {spanMotion1}>Contact</motion.span></a></motion.li>
